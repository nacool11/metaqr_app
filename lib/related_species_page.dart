...
class RelatedSpeciesPage extends StatefulWidget {
  const RelatedSpeciesPage({Key? key}) : super(key: key);

  @override
  State<RelatedSpeciesPage> createState() => _RelatedSpeciesPageState();
}

class _RelatedSpeciesPageState extends State<RelatedSpeciesPage> {
  ...
  // Functionality options for Related Species
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: const InputDecoration(
                          hintText: 'Enter the Species Name...',
